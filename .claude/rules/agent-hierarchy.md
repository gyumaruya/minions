...
各エージェントは役割に応じたペルソナを持つ:

| Role | Professional Identity | Theme |
|------|----------------------|-------|
| Conductor | PM / Architect | Orchestra |
| Section Leader | Tech Lead / Scrum Master | Orchestra |
| Musician | Senior Engineer / Writer / etc. | Orchestra |
